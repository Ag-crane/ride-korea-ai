      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
            <span className="whitespace-normal md:whitespace-nowrap">국내 자전거 경로 데이터 기반</span>
          </h2>
          ...
          <div className="aspect-[16/9] bg-gradient-to-br from-blue-400 to-blue-600 relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="bg-white/90 backdrop-blur-sm p-6 rounded-xl max-w-xl text-center">
                ...
                <p className="mb-4">
                  <span className="whitespace-normal md:whitespace-nowrap">한국의 최신 자전거도로 정보와 라이더들의 실제 데이터를 반영한 경로 안내</span>
                </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-gray-50 rounded-xl p-6 hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-600 mb-4">
              <span className="whitespace-normal md:whitespace-nowrap">국내 지형 데이터를 활용한 정밀한 고도 정보로 언덕과 경사를 미리 예측하세요.</span>
            </p>
          </div>
          <div className="bg-gray-50 rounded-xl p-6 hover:shadow-md transition-shadow">
            <h3 className="text-lg font-semibold mb-3 whitespace-normal md:whitespace-nowrap">자전거 도로 최적화</h3>
            <p className="text-gray-600 mb-4">
              <span className="whitespace-normal md:whitespace-nowrap">전국 자전거 도로와 추천 코스를 쉽게 탐색하고 내비게이션 할 수 있습니다.</span>
            </p>
          </div>
          <div className="bg-gray-50 rounded-xl p-6 hover:shadow-md transition-shadow">
            <h3 className="text-lg font-semibold mb-3 whitespace-normal md:whitespace-nowrap">실시간 경로 업데이트</h3>
            <p className="text-gray-600 mb-4">
              <span className="whitespace-normal md:whitespace-nowrap">공사, 폐쇄 등의 정보를 실시간으로 반영하여 항상 최적의 경로를 안내합니다.</span>
            </p>
          </div>
        </div>
      </div>

...
const features = [
  {
    ...
    description: '국내 지도 데이터를 기반으로 정확한 위치 추적 및 자전거 경로를 안내합니다. 외국 앱의 부정확한 경로 문제를 해결했습니다.'
  },
  {
    icon: <Navigation className="h-8 w-8 text-primary" />,
    title: '완벽한 현지화',
    description: '한국 라이더를 위한 UI 디자인과 100% 한국어 지원으로 언어 장벽 없이 라이딩에 집중할 수 있습니다.'
  },
  {
    icon: <Mic className="h-8 w-8 text-primary" />,
    title: 'AI 음성 페이스메이킹',
    description: '화면을 보지 않아도 AI가 실시간으로 코스의 고도와 속도를 분석하여 최적의 페이스를 음성으로 안내합니다.'
  }
];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-gray-600">
            외국 앱의 단점을 모두 해소하고, 한국 라이더를 위한 특별한 기능을 제공합니다.
          </p>
        </div>
        ...
        <div className="mt-16 bg-gray-50 rounded-2xl p-8">
          <h3 className="text-2xl font-semibold mb-6 text-center">외국 앱과의 차별점</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white rounded-xl p-6 shadow-sm">
              <h4 className="font-medium text-lg mb-4">외국 라이딩 앱</h4>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              <h4 className="font-medium text-lg mb-4">라이드코리아 AI</h4>
              <ul className="space-y-3">
                <li className="flex items-start">
